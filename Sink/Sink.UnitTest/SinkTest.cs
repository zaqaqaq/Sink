...
namespace Sink.UnitTest
{
    ...
    class JuicerPluginBuildTest
    {
        ...
        public void Test_WidthSink_Set_UnCorrectValueAddiction(double wrongWidthSink)
        {
            ...
            {
                _changeParameters.WidthSink = wrongWidthSink;
            }, "Диаметр тарелки должен быть не менее, чем на 96мм больше диаметра кола");/// длина равна ширине 1 к 1 450
        }
        ...
        [TestCase(100, Description = "Позитивный тест сеттера LengthSink")]
        ...
        [TestCase(500, Description = "Негативный тест сеттера HeightSink")]
        public void Test_HeightSink_Set_UnCorrectValueAddiction(double wrongHeightSink)
        {
            ...
            }, "Диаметр кола должен быть не менее, чем на 10мм больше высоты кола");/// 1k3 
        }

        [TestCase(58.4, Description = "Негативный тест сеттера HeightSink")]
        [TestCase(178.14, Description = "Негативный тест сеттера HeightSink")]
        ...
        [TestCase(11, Description = "Позитивный тест сеттера RadSink")]
